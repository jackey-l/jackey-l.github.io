...
favicon: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/favicon.png

# 用于苹果设备的图标
# Icon for Apple touch
apple_touch_icon: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/favicon.png
...
lazyload:
  ...
  loading_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/loading.gif
...
footer:
  ...
  beian:
    ...
    # 公安备案的图片. 为空时不显示备案图片
    police_icon: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/police_beian.png
...
index:
  ...
  banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/background/bg2.jpg
...
#---------------------------
post:
  banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/default.png
...
valine:
  ...
  appKey: VmLcKlwx0DLrqXB6ubPaCo9B
  placeholder: 说点什么
...
#---------------------------
archive:
  banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/background/wp5298648-anime-scenery-4k-wallpapers.jpg
...
category:
  enable: true
  banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/background/wp5475522-anime-scenery-4k-wallpapers.jpg
  banner_img_height: 70
  banner_mask_alpha: 0.3
  subtitle:
...
tag:
  enable: true
  banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/background/wp5475527-anime-scenery-4k-wallpapers.jpg
...
about:
  enable: true
  banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/background/wp5475501-anime-scenery-4k-wallpapers.jpg
  banner_img_height: 80
  banner_mask_alpha: 0.3
  subtitle:
  avatar: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/avatar.png
  name: "李国栋"
  intro: "兴趣广泛JAVA，分布式，Linux，容器化，云原生，嵌入式，单片机均有涉猎，坚持做自己喜欢的事。"
  # 更多图标可从 https://hexo.fluid-dev.com/docs/icon/ 查找，`class` 代表图标的 css class，添加 `qrcode` 后，图标不再是链接而是悬浮二维码
  # More icons can be found from https://hexo.fluid-dev.com/docs/en/icon/  `class` is the css class of the icon. If adding `qrcode`, The icon is no longer a link, but a hovering QR code
  icons:
    - { class: "iconfont icon-github-fill", link: "https://github.com/jackey-l", tip: "GitHub" }
...
links:
  ...
  onerror_avatar: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/avatar.png
