---
title: (转载)简单理解OAuth2.0
comments: true
index_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/oauth.png
banner_img: https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/background/vilige.jpg
date: 2021-10-18 11:31:48
updated: 2021-10-18 11:31:48
tags: [OAuth,认证,鉴权,分布式认证系统]
categories: 转载
---

原文https://www.ruanyifeng.com/blog/2019/04/oauth_design.html
...
![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040401.jpg)

小区有门禁系统。

![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040402.jpg)

进入的时候需要输入密码。

![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040403.jpg)

我经常网购和外卖，每天都有快递员来送货。我必须找到一个办法，让快递员通过门禁系统，进入小区。

![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040404.jpg)
...
OAuth 2.0 对于如何颁发令牌的细节，规定得非常详细。具体来说，一共分成四种授权类型（authorization grant），即四种颁发令牌的方式，适用于不同的互联网场景。下一章就来介绍这四种类型，并给出代码实例。

# OAuth 2.0 的四种方式

上一章介绍了 OAuth 2.0 是一种授权机制，主要用来颁发令牌（token）。本章接着介绍颁发令牌的实务操作。
...
![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040902.jpg)
...
![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040907.jpg)
...
![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040904.jpg)
...
![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040905.jpg)
...
![](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019040906.jpg)
...
下面演示一个实例，演示如何通过 OAuth 2.0 向 GitHub 的 API 申请令牌，然后再用令牌获取数据。

很多网站登录时，允许使用第三方网站的身份，这称为"第三方登录"。

![img](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019042101.jpg)
...
![img](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019042102.jpg)
...
![img](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019042103.jpg)
...
![img](https://cdn.jsdelivr.net/gh/jackey-l/blog_static@master/img/bg2019042104.png)
